              ...
              <div className='flex justify-between mt-[125px]'>
                <div className="child w-[431px] bg-[#6DF844] rounded-[25px] ">
                    <div  className='relative'>
                        <Image src={pop1} alt='image'/>
                    <Image className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2' src={playSign} alt='image'/>
                    </div>
